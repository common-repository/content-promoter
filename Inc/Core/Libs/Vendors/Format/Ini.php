...
namespace ContentPromoter\Core\Libs\Vendors\Format;

use ContentPromoter\Core\Libs\Vendors\AbstractRegistryFormat;
use ContentPromoter\Core\Helpers\ArrayHelper;
use stdClass;
